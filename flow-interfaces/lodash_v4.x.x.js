declare module 'lodash' {
  ...
  declare type IterateeWithResult<V, K, O, R> = ((value: V, key: K, object: O) => R) | string
  ...
  declare class Lodash {
    ...
    // alias of _.forEach
    each<A, K, T: ReadOnlyIndexerObject<A, K> | $ReadOnlyArray<A> | string | void | null>(
      collection: T,
      iteratee?: ?IterateeWithResult<A, K, T, boolean | void>
    ): T;
    // alias of _.forEachRight
    eachRight<A, K, T: ReadOnlyIndexerObject<A, K> | $ReadOnlyArray<A> | string | void | null>(
      collection: T,
      iteratee?: ?IterateeWithResult<A, K, T, boolean | void>
    ): T;
    ...
    filter<A, T: ReadOnlyIndexerObject<A>>(object: T, predicate?: OPredicate<A, T>): Array<A>;
    ...
    findLast<T>(array: void | null, predicate?: ?Predicate<T>, fromIndex?: ?number): void;
    ...
    forEach<A, K, T: ReadOnlyIndexerObject<A, K> | $ReadOnlyArray<A> | string | void | null>(
      collection: T,
      iteratee?: ?IterateeWithResult<A, K, T, boolean | void>
    ): T;
    forEachRight<A, K, T: ReadOnlyIndexerObject<A, K> | $ReadOnlyArray<A> | string | void | null>(
      collection: T,
      iteratee?: ?IterateeWithResult<A, K, T, boolean | void>
    ): T;
    groupBy<V, T>(
    ...
    map<V, T: ReadOnlyIndexerObject<V>, U>(object: ?T, iteratee?: OMapIterator<V, T, U>): Array<U>;
    ...
    reject<A, T: ReadOnlyIndexerObject<A>>(object?: ?T, predicate?: ?OPredicate<A, T>): Array<A>;
    ...
    some<A, T: ReadOnlyIndexerObject<A>>(object?: ?T, predicate?: OPredicate<A, T>): boolean;
...
declare module 'lodash/fp' {
  ...
  declare type OIterateeWithResult<V, R> = ReadOnlyIndexerObject<V> | IterateeWithResult<V, R>
  ...
  declare class Lodash {
    ...
    countBy<T>(iteratee: ValueOnlyIteratee<T>, collection: Collection<T>): {[string]: number, ...};
    // alias of _.forEach
    each<T>(iteratee: Iteratee<T> | OIteratee<T>): (collection: Collection<T>) => Array<T>;
    each<T>(iteratee: Iteratee<T> | OIteratee<T>, collection: Collection<T>): Array<T>;
    // alias of _.forEachRight
    eachRight<T>(iteratee: Iteratee<T> | OIteratee<T>): (collection: Collection<T>) => Array<T>;
    eachRight<T>(iteratee: Iteratee<T> | OIteratee<T>, collection: Collection<T>): Array<T>;
    every<T>(iteratee: Iteratee<T> | OIteratee<T>): (collection: Collection<T>) => boolean;
    every<T>(iteratee: Iteratee<T> | OIteratee<T>, collection: Collection<T>): boolean;
    all<T>(iteratee: Iteratee<T> | OIteratee<T>): (collection: Collection<T>) => boolean;
    all<T>(iteratee: Iteratee<T> | OIteratee<T>, collection: Collection<T>): boolean;
    filter<T>(predicate: Predicate<T> | OPredicate<T>): (collection: Collection<T>) => Array<T>;
    filter<T>(predicate: Predicate<T> | OPredicate<T>, collection: Collection<T>): Array<T>;
    find<T>(predicate: Predicate<T> | OPredicate<T>): (collection: Collection<T>) => T | void;
    find<T>(predicate: Predicate<T> | OPredicate<T>, collection: Collection<T>): T | void;
    findFrom<T>(
    ...
    findLast<T>(predicate: Predicate<T> | OPredicate<T>): (collection: Collection<T>) => T | void;
    findLast<T>(predicate: Predicate<T> | OPredicate<T>, collection: Collection<T>): T | void;
    findLastFrom<T>(
      predicate: Predicate<T> | OPredicate<T>
    ): ((fromIndex: number) => (collection: Collection<T>) => T | void) &
    ...
    forEach<T>(iteratee: Iteratee<T> | OIteratee<T>): (collection: Collection<T>) => Array<T>;
    forEach<T>(iteratee: Iteratee<T> | OIteratee<T>, collection: Collection<T>): Array<T>;
    forEachRight<T>(iteratee: Iteratee<T> | OIteratee<T>): (collection: Collection<T>) => Array<T>;
    forEachRight<T>(iteratee: Iteratee<T> | OIteratee<T>, collection: Collection<T>): Array<T>;
    groupBy<V, T>(
      iteratee: ValueOnlyIteratee<T>
    ...
    includesFrom<T>(value: T, fromIndex: number, collection: $ReadOnlyArray<T>): boolean;
    invokeMap<T>(path: ((value: T) => Path) | Path): (collection: Collection<T>) => Array<any>;
    invokeMap<T>(path: ((value: T) => Path) | Path, collection: Collection<T>): Array<any>;
    invokeArgsMap<T>(
      path: ((value: T) => Path) | Path
    ...
    keyBy<T, V>(iteratee: ValueOnlyIteratee<T>): (collection: Collection<T>) => {[key: V]: T, ...};
    keyBy<T, V>(iteratee: ValueOnlyIteratee<T>, collection: Collection<T>): {[key: V]: T, ...};
    indexBy<T, V>(
      iteratee: ValueOnlyIteratee<T>
    ): (collection: Collection<T>) => {[key: V]: T, ...};
    indexBy<T, V>(iteratee: ValueOnlyIteratee<T>, collection: Collection<T>): {[key: V]: T, ...};
    map<T, U>(
    ...
    orderBy<T>(
      ...
      ((orders: $ReadOnlyArray<'asc' | 'desc'> | string, collection: Collection<T>) => Array<T>);
    orderBy<T>(
      iteratees: $ReadOnlyArray<Iteratee<T> | OIteratee<*>> | string,
      orders: $ReadOnlyArray<'asc' | 'desc'> | string
    ): (collection: Collection<T>) => Array<T>;
    ...
    reject<T>(predicate: Predicate<T> | OPredicate<T>): (collection: Collection<T>) => Array<T>;
    reject<T>(predicate: Predicate<T> | OPredicate<T>, collection: Collection<T>): Array<T>;
    sample<T>(collection: Collection<T>): T;
    ...
    some<T>(predicate: Predicate<T> | OPredicate<T>): (collection: Collection<T>) => boolean;
    some<T>(predicate: Predicate<T> | OPredicate<T>, collection: Collection<T>): boolean;
    any<T>(predicate: Predicate<T> | OPredicate<T>): (collection: Collection<T>) => boolean;
    any<T>(predicate: Predicate<T> | OPredicate<T>, collection: Collection<T>): boolean;
    sortBy<T>(
    ...
    findKey<A, T: ReadOnlyIndexerObject<A>>(predicate: OPredicate<A>): (object: T) => string | void;
    findKey<A, T: ReadOnlyIndexerObject<A>>(predicate: OPredicate<A>, object: T): string | void;
    findLastKey<A, T: ReadOnlyIndexerObject<A>>(
      predicate: OPredicate<A>
    ): (object: T) => string | void;
    findLastKey<A, T: ReadOnlyIndexerObject<A>>(predicate: OPredicate<A>, object: T): string | void;
